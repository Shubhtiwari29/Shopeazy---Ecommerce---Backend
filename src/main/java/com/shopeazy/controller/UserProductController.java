...
public class UserProductController {
	...
	/*
	 * @GetMapping("/products/search") public
	 * ResponseEntity<List<Product>>searchProductHandler(@RequestParam String q){
	 * List<Product>products =productService.searchProduct(q); return new
